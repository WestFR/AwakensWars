...
I18n.translations = {
  en: {
    ...
    detailCharacterMass: 'Mass : ',
    detailCharacterHairColor: 'Hair color : ',
    detailCharacterSkinColor: 'Skin color : ',
    detailCharacterEyeColor: 'Eyes Color : ',
    detailCharacterBirthday: 'Year of birth : ',
    detailCharacterHomeworld : 'Home : ',

    detailPlanetTitle: 'Planet : ',
    detailPlanetName: 'Planet name : ',
    detailPlanetCaract: 'Rotation / orbital period : ',
    detailPlanetDiameter: 'Diameter : ',
    ...
    detailtarshipModel: 'Model : ',
    detailStarshipClass: 'Class : ',
    detailStarshipCost: 'Cost : ',
    detailStarshipLength: 'Length : ',
    detailStarshipPassengers: 'Passengers : ',
    detailStarshipConsumables: 'Consumables capacity : ',
    detailStarshipCargoCapacity: 'Cargo capacity : ',
